...
exports.ltrim = function (mockInstance, key, startIndex, endIndex, callback) {
    ...
    var trimmedList = Item._list.prototype.ltrim.call( mockInstance.storage[key], startIndex, endIndex );
    mockInstance._callCallback(callback, null, trimmedList );
};
...
exports.lrange = function (mockInstance, key, start, end, callback) {
  ...
  return mockInstance._callCallback(
    callback,
    null,
    mockInstance.storage[key].value.slice(start, end+1)
  );
};
