...
var CMD_FACTORY = {
  ...
  list: {
    lib: require('./list.js'),
    commands: [ 'llen', 'lpush', 'rpush', 'lpushx', 'rpushx', 'lpop', 'rpop', 'brpop', 'blpop', 'lindex', 'lset', 'rpoplpush', 'lrange', 'ltrim' ]
  },
  set: {
    lib: require('./set.js'),
  ...
  sortedset: {
    ...
    commands: [ 'zadd', 'zrem', 'zcard', 'zrange', 'zrevrange', 'zrank', 'zrevrank', 'zscore', 'zincrby' ]
  },
  server: {
...
RedisClient.prototype.watch = RedisClient.prototype.WATCH = function(key, cb) {
  return transactionfunctions.watch.call(this, MockInstance, key, cb);
}
RedisClient.prototype.unwatch = RedisClient.prototype.UNWATCH = function(key, cb) {
  return transactionfunctions.unwatch.call(this, MockInstance, key, cb);
}
...
RedisMock.prototype.createMockRedis = function() {
    'use strict';
